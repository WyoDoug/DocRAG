...
param(
    ...
    [string]$DisplayName = 'DocRAG MCP Server',
...
function Register-DocRagService
{
    param(
        [string]$Name,
        [string]$BinPath,
...
try
{
    Register-DocRagService -Name $ServiceName -BinPath $BinaryPath -Display $DisplayName -Desc $Description -Sw $sw
}
catch
{
