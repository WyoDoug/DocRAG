...
builder.Services.Configure<SaddleRAG.Core.Models.RankingSettings>(builder.Configuration.GetSection(SaddleRAG.Core.Models.RankingSettings.SectionName));
...
builder.Services.AddSingleton<SaddleRAG.Ingestion.Recon.LibraryProfileService>();
builder.Services.AddSingleton<SaddleRAG.Ingestion.Recon.CliReconFallback>();
